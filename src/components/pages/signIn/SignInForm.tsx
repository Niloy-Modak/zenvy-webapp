  ...
  return (
    <div className="w-full max-w-md">
      ...
      <form className="flex flex-col gap-5 p-7 rounded-3xl bg-background/50 backdrop-blur-xl border border-white/70 shadow-2xl relative overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col gap-3 mb-2">
            <label htmlFor="email" className="text-sm font-semibold text-gray-900 tracking-tight">
              Email Address
            </label>
            <div
          ...
          <div className="flex flex-col gap-3 mb-2">
            <div className="flex items-center justify-between">
              <label htmlFor="password" className="text-sm font-semibold text-gray-900 tracking-tight">
                Password
              </label>
              <Link href="/forgot-password" className="text-xs font-semibold text-primary hover:text-primary/80 transition-colors duration-200">
                Forgot?
              </Link>
            </div>
            <div
          ...
          <div className="flex items-center gap-3 my-5 px-1">
            <input
              type="checkbox"
              id="remember"
              className="w-5 h-5 accent-primary rounded-lg cursor-pointer border border-primary/40 transition-all duration-300"
              defaultChecked
            />
      ...
      <p className="text-center text-sm text-gray-600 mt-8 font-medium">
        ...
        <Link href="/sign-up" className="font-semibold text-primary hover:text-primary/80 transition-colors duration-200">
          Sign up
        </Link>
      </p>
    </div>
